                        ...
                        <div class="card-body">
                            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select id="kategori" class="form-control" @error('category') is-invalid @enderror" name="category" value="{{ old('category') }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('body_content') is-invalid @enderror" id="myeditorinstance" name="body_content" value="{{ old('body_content') }}"></textarea>
